...
func TestToANSIForeground_TrueColor(t *testing.T) {
	...
	tests := []struct {
		...
		{"Red", value2.RGB(255, 0, 0), "\x1b[38;2;255;0;0m"},
		{"Green", value2.RGB(0, 255, 0), "\x1b[38;2;0;255;0m"},
		{"Blue", value2.RGB(0, 0, 255), "\x1b[38;2;0;0;255m"},
		{"White", value2.RGB(255, 255, 255), "\x1b[38;2;255;255;255m"},
		{"Black", value2.RGB(0, 0, 0), "\x1b[38;2;0;0;0m"},
		{"Custom", value2.RGB(123, 45, 67), "\x1b[38;2;123;45;67m"},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := adapter.ToANSIForeground(tt.color, value2.TrueColor)
			if got != tt.want {
...
func TestToANSIBackground_TrueColor(t *testing.T) {
	...
	tests := []struct {
		...
		{"Red", value2.RGB(255, 0, 0), "\x1b[48;2;255;0;0m"},
		{"Green", value2.RGB(0, 255, 0), "\x1b[48;2;0;255;0m"},
		{"Blue", value2.RGB(0, 0, 255), "\x1b[48;2;0;0;255m"},
		{"White", value2.RGB(255, 255, 255), "\x1b[48;2;255;255;255m"},
		{"Black", value2.RGB(0, 0, 0), "\x1b[48;2;0;0;0m"},
		{"Custom", value2.RGB(123, 45, 67), "\x1b[48;2;123;45;67m"},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := adapter.ToANSIBackground(tt.color, value2.TrueColor)
			if got != tt.want {
...
func TestToANSIForeground_ANSI256(t *testing.T) {
	...
	tests := []struct {
		...
		{"Red", value2.RGB(255, 0, 0)},
		{"Green", value2.RGB(0, 255, 0)},
		{"Blue", value2.RGB(0, 0, 255)},
		{"White", value2.RGB(255, 255, 255)},
		{"Black", value2.RGB(0, 0, 0)},
		{"Gray", value2.RGB(128, 128, 128)},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := adapter.ToANSIForeground(tt.color, value2.ANSI256)
...
func TestToANSIBackground_ANSI256(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := adapter.ToANSIBackground(tt.color, value2.ANSI256)
...
func TestToANSIForeground_ANSI16(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := adapter.ToANSIForeground(tt.color, value2.ANSI16)
...
func TestToANSIBackground_ANSI16(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := adapter.ToANSIBackground(tt.color, value2.ANSI16)
...
func TestToANSI_NoColor(t *testing.T) {
	...
	fg := adapter.ToANSIForeground(color, value2.NoColor)
	if fg != "" {
		t.Errorf("ToANSIForeground(NoColor) = %q, want %q", fg, "")
	}

	bg := adapter.ToANSIBackground(color, value2.NoColor)
	if bg != "" {
...
func TestRGBToANSI256_Grayscale(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			color := value2.RGB(tt.r, tt.g, tt.b)
...
func TestColorAdaptation_SameColorDifferentCapabilities(t *testing.T) {
	adapter := NewColorAdapter()
	color := value2.RGB(123, 45, 67)

	trueColor := adapter.ToANSIForeground(color, value2.TrueColor)
	ansi256 := adapter.ToANSIForeground(color, value2.ANSI256)
	ansi16 := adapter.ToANSIForeground(color, value2.ANSI16)
	noColor := adapter.ToANSIForeground(color, value2.NoColor)
