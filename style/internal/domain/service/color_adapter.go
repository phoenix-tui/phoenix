...
type ColorAdapter interface {
	...
	ToANSIForeground(color value2.Color, capability value2.TerminalCapability) string

	// ToANSIBackground converts a color to an ANSI background code.
	ToANSIBackground(color value2.Color, capability value2.TerminalCapability) string
}
...
func (a *DefaultColorAdapter) ToANSIForeground(color value2.Color, capability value2.TerminalCapability) string {
	switch capability {
	case value2.NoColor:
		return ""
	case value2.ANSI16:
...
func (a *DefaultColorAdapter) ToANSIBackground(color value2.Color, capability value2.TerminalCapability) string {
	switch capability {
	case value2.NoColor:
		return ""
	case value2.ANSI16:
...
func (a *DefaultColorAdapter) toTrueColorForeground(color value2.Color) string {
	r, g, b := color.RGB()
	return fmt.Sprintf("\x1b[38;2;%d;%d;%dm", r, g, b)
}

func (a *DefaultColorAdapter) toTrueColorBackground(color value2.Color) string {
	r, g, b := color.RGB()
...
func (a *DefaultColorAdapter) toANSI256Foreground(color value2.Color) string {
	code := a.rgbToANSI256(color)
	return fmt.Sprintf("\x1b[38;5;%dm", code)
}

func (a *DefaultColorAdapter) toANSI256Background(color value2.Color) string {
	code := a.rgbToANSI256(color)
...
func (a *DefaultColorAdapter) rgbToANSI256(color value2.Color) uint8 {
	r, g, b := color.RGB()
...
func (a *DefaultColorAdapter) toANSI16Foreground(color value2.Color) string {
...
func (a *DefaultColorAdapter) toANSI16Background(color value2.Color) string {
	code := a.rgbToANSI16(color)
	if code >= 8 {
...
func (a *DefaultColorAdapter) rgbToANSI16(color value2.Color) uint8 {
