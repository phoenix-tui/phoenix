...
type Style struct {
	// Color properties.
	foreground *value2.Color
	background *value2.Color

	// Border properties.
	border       *value2.Border
	borderColor  *value2.Color
	borderTop    bool
	borderBottom bool
	borderLeft   bool
	borderRight  bool
	...
	terminalCapability value2.TerminalCapability
}
...
func NewStyle() Style {
	return Style{
		...
		underline:          false,
		strikethrough:      false,
		terminalCapability: value2.TrueColor,
	}
}
...
func (s Style) Foreground(c value2.Color) Style {
	s.foreground = &c
	return s
}
...
// Returns a new Style instance (immutability).
func (s Style) Background(c value2.Color) Style {
	s.background = &c
	return s
}
...
// Returns a new Style instance (immutability).
func (s Style) Border(b value2.Border) Style {
	s.border = &b
...
// Returns a new Style instance (immutability).
func (s Style) BorderColor(c value2.Color) Style {
	s.borderColor = &c
	return s
}
...
// Returns a new Style instance (immutability).
func (s Style) Padding(p value2.Padding) Style {
	s.padding = &p
	return s
}
...
func (s Style) PaddingTop(top int) Style {
	if s.padding == nil {
		s.padding = &value2.Padding{}
	}
	updated := value2.NewPadding(top, s.padding.Right(), s.padding.Bottom(), s.padding.Left())
	s.padding = &updated
	return s
}
...
func (s Style) PaddingRight(right int) Style {
	...
	updated := value2.NewPadding(s.padding.Top(), right, s.padding.Bottom(), s.padding.Left())
	s.padding = &updated
	return s
}
...
func (s Style) PaddingBottom(bottom int) Style {
	...
	updated := value2.NewPadding(s.padding.Top(), s.padding.Right(), bottom, s.padding.Left())
	s.padding = &updated
	return s
}
...
func (s Style) PaddingLeft(left int) Style {
	...
	updated := value2.NewPadding(s.padding.Top(), s.padding.Right(), s.padding.Bottom(), left)
	s.padding = &updated
	return s
}
...
func (s Style) PaddingAll(all int) Style {
	padding := value2.NewPadding(all, all, all, all)
	s.padding = &padding
	return s
}
...
func (s Style) PaddingHorizontal(horizontal int) Style {
	...
	updated := value2.NewPadding(s.padding.Top(), horizontal, s.padding.Bottom(), horizontal)
	s.padding = &updated
	return s
}
...
func (s Style) PaddingVertical(vertical int) Style {
	...
	updated := value2.NewPadding(vertical, s.padding.Right(), vertical, s.padding.Left())
	s.padding = &updated
	return s
}
...
// Returns a new Style instance (immutability).
func (s Style) Margin(m value2.Margin) Style {
	s.margin = &m
	return s
}
...
func (s Style) MarginTop(top int) Style {
	if s.margin == nil {
		s.margin = &value2.Margin{}
	}
	updated := value2.NewMargin(top, s.margin.Right(), s.margin.Bottom(), s.margin.Left())
	s.margin = &updated
	return s
}
...
func (s Style) MarginRight(right int) Style {
	...
	updated := value2.NewMargin(s.margin.Top(), right, s.margin.Bottom(), s.margin.Left())
	s.margin = &updated
	return s
}
...
func (s Style) MarginBottom(bottom int) Style {
	...
	updated := value2.NewMargin(s.margin.Top(), s.margin.Right(), bottom, s.margin.Left())
	s.margin = &updated
	return s
}
...
func (s Style) MarginLeft(left int) Style {
	...
	updated := value2.NewMargin(s.margin.Top(), s.margin.Right(), s.margin.Bottom(), left)
	s.margin = &updated
	return s
}
...
func (s Style) MarginAll(all int) Style {
	margin := value2.NewMargin(all, all, all, all)
	s.margin = &margin
	return s
}
...
func (s Style) MarginHorizontal(horizontal int) Style {
	...
	updated := value2.NewMargin(s.margin.Top(), horizontal, s.margin.Bottom(), horizontal)
	s.margin = &updated
	return s
}
...
func (s Style) MarginVertical(vertical int) Style {
	...
	updated := value2.NewMargin(vertical, s.margin.Right(), vertical, s.margin.Left())
	s.margin = &updated
	return s
}
...
// Returns a new Style instance (immutability).
func (s Style) Align(a value2.Alignment) Style {
	s.alignment = &a
	return s
}
...
// Returns a new Style instance (immutability).
func (s Style) AlignHorizontal(h value2.HorizontalAlignment) Style {
	if s.alignment == nil {
		alignment := value2.NewAlignment(h, value2.AlignTop)
		s.alignment = &alignment
	} else {
		updated := value2.NewAlignment(h, s.alignment.Vertical())
		s.alignment = &updated
	}
	return s
}
...
// Returns a new Style instance (immutability).
func (s Style) AlignVertical(v value2.VerticalAlignment) Style {
	if s.alignment == nil {
		alignment := value2.NewAlignment(value2.AlignLeft, v)
		s.alignment = &alignment
	} else {
		updated := value2.NewAlignment(s.alignment.Horizontal(), v)
		s.alignment = &updated
	}
	return s
}
...
// Returns a new Style instance (immutability).
func (s Style) TerminalCapability(tc value2.TerminalCapability) Style {
...
func (s Style) GetForeground() (value2.Color, bool) {
	if s.foreground == nil {
		return value2.Color{}, false
	}
...
// Returns (color, true) if set, (zero value, false) otherwise.
func (s Style) GetBackground() (value2.Color, bool) {
	if s.background == nil {
		return value2.Color{}, false
	}
...
func (s Style) GetBorder() (value2.Border, bool) {
	if s.border == nil {
		return value2.Border{}, false
	}
...
// Returns (color, true) if set, (zero value, false) otherwise.
func (s Style) GetBorderColor() (value2.Color, bool) {
...
func (s Style) GetPadding() (value2.Padding, bool) {
	if s.padding == nil {
		return value2.Padding{}, false
	}
...
func (s Style) GetMargin() (value2.Margin, bool) {
	if s.margin == nil {
		return value2.Margin{}, false
	}
...
func (s Style) GetSize() (value2.Size, bool) {
	if s.size == nil {
		return value2.Size{}, false
	}
	return *s.size, true
}
...
func (s Style) GetAlignment() (value2.Alignment, bool) {
	if s.alignment == nil {
		return value2.Alignment{}, false
	}
...
func (s Style) GetTerminalCapability() value2.TerminalCapability {
