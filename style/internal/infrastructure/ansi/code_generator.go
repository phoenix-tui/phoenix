...
// Reverse generates an ANSI escape code for reverse video (swap fg/bg colors).
// Format: ESC[7m.
func (gen *ANSICodeGenerator) Reverse() string {
	return "\x1b[7m"
}

// ReverseOff generates an ANSI escape code to turn off reverse video.
// Format: ESC[27m.
func (gen *ANSICodeGenerator) ReverseOff() string {
	return "\x1b[27m"
}
