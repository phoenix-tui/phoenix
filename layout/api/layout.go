...
import (
	...
	"github.com/phoenix-tui/phoenix/layout/domain/service"
...
func (b *Box) Padding(top, right, bottom, left int) *Box {
	b.domain = b.domain.WithPadding(value.NewSpacing(top, right, bottom, left))
	return b
}
...
func (b *Box) PaddingAll(padding int) *Box {
	b.domain = b.domain.WithPadding(value.NewSpacingAll(padding))
	return b
}
...
func (b *Box) PaddingVH(vertical, horizontal int) *Box {
	b.domain = b.domain.WithPadding(value.NewSpacingVH(vertical, horizontal))
	return b
}
...
func (b *Box) Margin(top, right, bottom, left int) *Box {
	b.domain = b.domain.WithMargin(value.NewSpacing(top, right, bottom, left))
	return b
}
...
func (b *Box) MarginAll(margin int) *Box {
	b.domain = b.domain.WithMargin(value.NewSpacingAll(margin))
	return b
}
...
func (b *Box) MarginVH(vertical, horizontal int) *Box {
	b.domain = b.domain.WithMargin(value.NewSpacingVH(vertical, horizontal))
	return b
}
...
func (b *Box) AlignLeft() *Box {
	b.domain = b.domain.WithAlignment(value.NewAlignmentDefault())
	return b
}
...
func (b *Box) AlignCenter() *Box {
	b.domain = b.domain.WithAlignment(value.NewAlignmentCenter())
	return b
}
...
func (b *Box) AlignRight() *Box {
	align := value.NewAlignment(value.AlignRight, value.AlignTop)
...
func (b *Box) AlignTop() *Box {
	align := value.NewAlignment(value.AlignLeft, value.AlignTop)
	b.domain = b.domain.WithAlignment(align)
	return b
}
...
func (b *Box) AlignMiddle() *Box {
	align := value.NewAlignment(value.AlignLeft, value.AlignMiddle)
	b.domain = b.domain.WithAlignment(align)
	return b
}
...
func (b *Box) AlignBottom() *Box {
	align := value.NewAlignment(value.AlignLeft, value.AlignBottom)
	b.domain = b.domain.WithAlignment(align)
	return b
}
...
func (b *Box) Align(horizontal value.HorizontalAlignment, vertical value.VerticalAlignment) *Box {
	b.domain = b.domain.WithAlignment(value.NewAlignment(horizontal, vertical))
	return b
}
...
func (b *Box) Render() string {
	...
	measureService := service.NewMeasureService(unicodeService)
	...
	b.domain = b.domain.WithSize(value.NewSizeExact(size.Width(), size.Height()))
...
func (b *Box) Layout(parentWidth, parentHeight int) value.Position {
	// Create services
	unicodeService := coreService.NewUnicodeService()
	measureService := service.NewMeasureService(unicodeService)
	layoutService := service.NewLayoutService(measureService)

	// Layout the box
	parentSize := value.NewSizeExact(parentWidth, parentHeight)
...
func Row() *Flex {
	return &Flex{
		domain: model.NewFlexContainer(value.FlexDirectionRow),
	}
}
...
func Column() *Flex {
	return &Flex{
		domain: model.NewFlexContainer(value.FlexDirectionColumn),
	}
}
...
func (f *Flex) JustifyStart() *Flex {
	f.domain = f.domain.WithJustifyContent(value.JustifyContentStart)
	return f
}
...
func (f *Flex) JustifyEnd() *Flex {
	f.domain = f.domain.WithJustifyContent(value.JustifyContentEnd)
	return f
}
...
func (f *Flex) JustifyCenter() *Flex {
	f.domain = f.domain.WithJustifyContent(value.JustifyContentCenter)
	return f
}
...
func (f *Flex) JustifySpaceBetween() *Flex {
	f.domain = f.domain.WithJustifyContent(value.JustifyContentSpaceBetween)
	return f
}
...
func (f *Flex) AlignStretch() *Flex {
	f.domain = f.domain.WithAlignItems(value.AlignItemsStretch)
	return f
}
...
func (f *Flex) AlignStart() *Flex {
	f.domain = f.domain.WithAlignItems(value.AlignItemsStart)
	return f
}
...
func (f *Flex) AlignEnd() *Flex {
	f.domain = f.domain.WithAlignItems(value.AlignItemsEnd)
	return f
}
...
func (f *Flex) AlignCenter() *Flex {
	f.domain = f.domain.WithAlignItems(value.AlignItemsCenter)
	return f
}
...
func (f *Flex) Render(containerWidth, containerHeight int) string {
	...
	unicodeService := coreService.NewUnicodeService()
	measureService := service.NewMeasureService(unicodeService)
	flexService := service.NewFlexboxLayoutService(measureService)
	renderService := service.NewRenderService()
...
func (f *Flex) Domain() *model.FlexContainer {
	return f.domain
}
