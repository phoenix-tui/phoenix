...
type Box struct {
	...
	padding   value2.Spacing   // Inner spacing (inside border)
	margin    value2.Spacing   // Outer spacing (outside border)
	hasBorder bool             // Whether box has border
	size      value2.Size      // Size constraints
	alignment value2.Alignment // Alignment within parent
}
...
func NewBox(content string) *Box {
	...
	return &Box{
		...
		alignment: value2.NewAlignmentDefault(),
	}
}
...
func (b *Box) Padding() value2.Spacing {
	return b.padding
}

// Margin returns the margin spacing.
func (b *Box) Margin() value2.Spacing {
	return b.margin
}
...
func (b *Box) Size() value2.Size {
	return b.size
}

// Alignment returns the alignment within parent.
func (b *Box) Alignment() value2.Alignment {
	return b.alignment
}
...
func (b *Box) WithPadding(p value2.Spacing) *Box {
	result := *b
	result.padding = p
	return &result
}
...
func (b *Box) WithMargin(m value2.Spacing) *Box {
	result := *b
	result.margin = m
	return &result
}
...
func (b *Box) WithSize(s value2.Size) *Box {
	result := *b
	result.size = s
	return &result
}
...
func (b *Box) WithAlignment(a value2.Alignment) *Box {
	result := *b
	result.alignment = a
	return &result
}
...
func (b *Box) ContentSize() value2.Size {
	...
	return value2.NewSizeExact(maxWidth, height)
}
...
func (b *Box) PaddedSize() value2.Size {
	...
	return value2.NewSizeExact(width, height)
}
...
func (b *Box) BorderedSize() value2.Size {
	padded := b.PaddedSize()
...
func (b *Box) TotalSize() value2.Size {
