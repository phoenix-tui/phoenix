...
func TestBox_PaddedSize(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			content:        "A\nB\nC",
			padding:        value2.NewSpacingVH(2, 3),
...
func TestBox_TotalSize(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			margin:         value2.NewSpacing(2, 1, 2, 1),
			hasBorder:      true,
...
func TestBox_FluentAPI(t *testing.T) {
	box := NewBox("Test").
		WithPadding(value2.NewSpacingAll(1)).
		WithMargin(value2.NewSpacingVH(1, 2)).
		WithBorder(true).
...
func TestBox_Immutability(t *testing.T) {
	...
	_ = original.WithPadding(value2.NewSpacingAll(2))
	_ = original.WithMargin(value2.NewSpacingAll(2))
	_ = original.WithBorder(false)
	_ = original.WithSize(value2.NewSizeExact(100, 30))
	_ = original.WithAlignment(value2.NewAlignmentDefault())
