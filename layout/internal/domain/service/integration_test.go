...
func TestIntegration_MeasureAndLayout(t *testing.T) {
	...
	t.Run("Unicode content", func(_ *testing.T) {
		box := model2.NewBox("你好世界"). // 4 CJK chars = 8 cells
						WithAlignment(value2.NewAlignmentCenter())
...
func TestIntegration_FullPipeline(t *testing.T) {
	...
	t.Run("Unicode content workflow", func(_ *testing.T) {
		box := model2.NewBox("你好 👋").
			WithPadding(value2.NewSpacingAll(1)).
			WithBorder(true).
			WithAlignment(value2.NewAlignmentCenter())

		parentSize := value2.NewSizeExact(40, 10)
...
func TestIntegration_RealWorldScenarios(t *testing.T) {
	...
	t.Run("centered modal dialog", func(_ *testing.T) {
		box := model2.NewBox("Confirm Action\n\nAre you sure you want to continue?\n\n[Yes] [No]").
			WithPadding(value2.NewSpacingVH(1, 3)).
			WithBorder(true).
			WithAlignment(value2.NewAlignmentCenter())
	...
	t.Run("status bar (bottom-left)", func(_ *testing.T) {
		box := model2.NewBox("Ready | Line 42 | UTF-8").
	...
	t.Run("title bar (top-center)", func(_ *testing.T) {
		box := model2.NewBox("Phoenix TUI Editor v1.0").
			WithPadding(value2.NewSpacing(0, 2, 0, 2)).
			WithAlignment(value2.NewAlignment(value2.AlignCenter, value2.AlignTop))
	...
	t.Run("sidebar menu (right-aligned)", func(_ *testing.T) {
		box := model2.NewBox("File\nEdit\nView\nHelp").
			WithPadding(value2.NewSpacingVH(0, 1)).
			WithBorder(true).
...
func TestIntegration_Performance(t *testing.T) {
	...
	t.Run("measure 1000 boxes", func(_ *testing.T) {
		box := model2.NewBox("Test content").
			WithPadding(value2.NewSpacingAll(1)).
			WithBorder(true)
	...
	t.Run("full pipeline 1000 times", func(_ *testing.T) {
		box := model2.NewBox("Performance test").
			WithPadding(value2.NewSpacingAll(1)).
			WithBorder(true).
			WithAlignment(value2.NewAlignmentCenter())
		parentSize := value2.NewSizeExact(80, 24)
