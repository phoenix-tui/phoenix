...
func TestOptimizeService_BatchStyles(t *testing.T) {
	...
	ops := []DiffOp{
		{Type: OpTypeSet, Position: value2.NewPosition(0, 0), Cell: model.NewCell('A', style)},
		{Type: OpTypeSet, Position: value2.NewPosition(1, 0), Cell: model.NewCell('B', style)},
		{Type: OpTypeSet, Position: value2.NewPosition(2, 0), Cell: model.NewCell('C', style)},
	}
...
func TestOptimizeService_RemoveRedundant(t *testing.T) {
	...
	ops := []DiffOp{
		{Type: OpTypeSet, Position: value2.NewPosition(0, 0), Cell: model.NewCell('A', style1)},
		{Type: OpTypeSet, Position: value2.NewPosition(1, 0), Cell: model.NewCell('B', style1)},
		{Type: OpTypeSet, Position: value2.NewPosition(2, 0), Cell: model.NewCell('C', style2)},
	}

	currentStyle := value2.NewStyle()
...
func TestOptimizeService_RemoveRedundant_EmptyOps(t *testing.T) {
	...
	result := svc.RemoveRedundant(ops, value2.NewStyle())
...
func TestOptimizeService_OptimizeCursorMoves(t *testing.T) {
	...
	ops := []DiffOp{
		{Type: OpTypeMoveCursor, Position: value2.NewPosition(0, 0)},
		{Type: OpTypeSet, Position: value2.NewPosition(0, 0), Cell: model.NewCell('A', value2.NewStyle())},
		{Type: OpTypeMoveCursor, Position: value2.NewPosition(1, 0)},
		{Type: OpTypeSet, Position: value2.NewPosition(1, 0), Cell: model.NewCell('B', value2.NewStyle())},
	}
...
func TestOptimizeService_MergeAdjacentOps(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			[]DiffOp{
				{Type: OpTypeSet, Position: value2.NewPosition(0, 0), Cell: model.NewCell('A', style)},
				{Type: OpTypeSet, Position: value2.NewPosition(5, 0), Cell: model.NewCell('B', style)},
			},
			2,
		},
		{
...
func TestOptimizeService_EstimateOutputSize(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			[]DiffOp{
				{Type: OpTypeMoveCursor, Position: value2.NewPosition(0, 0)},
				{Type: OpTypeMoveCursor, Position: value2.NewPosition(10, 5)},
			},
		},
		{
			"clear operations",
			[]DiffOp{
				{Type: OpTypeClear, Position: value2.NewPosition(0, 0)},
			},
		},
		{
			"mixed operations",
			[]DiffOp{
				{Type: OpTypeSet, Position: value2.NewPosition(0, 0), Cell: model.NewCell('A', value2.NewStyle())},
				{Type: OpTypeMoveCursor, Position: value2.NewPosition(1, 0)},
				{Type: OpTypeClear, Position: value2.NewPosition(2, 0)},
			},
		},
	}
...
func TestOptimizeService_GroupByLine(t *testing.T) {
	...
	ops := []DiffOp{
		{Type: OpTypeSet, Position: value2.NewPosition(0, 0), Cell: model.NewCell('A', value2.NewStyle())},
		{Type: OpTypeSet, Position: value2.NewPosition(1, 0), Cell: model.NewCell('B', value2.NewStyle())},
		{Type: OpTypeSet, Position: value2.NewPosition(0, 1), Cell: model.NewCell('C', value2.NewStyle())},
		{Type: OpTypeSet, Position: value2.NewPosition(0, 2), Cell: model.NewCell('D', value2.NewStyle())},
		{Type: OpTypeSet, Position: value2.NewPosition(1, 2), Cell: model.NewCell('E', value2.NewStyle())},
	}
...
func BenchmarkOptimizeService_RemoveRedundant(b *testing.B) {
	...
	for i := 0; i < 100; i++ {
		ops[i] = DiffOp{
			Type:     OpTypeSet,
			Position: value2.NewPosition(i, 0),
...
func BenchmarkOptimizeService_GroupByLine(b *testing.B) {
	...
	for i := 0; i < 1000; i++ {
		ops[i] = DiffOp{
			Type:     OpTypeSet,
			Position: value2.NewPosition(i%80, i/80),
			Cell:     model.NewCell('A', style),
		}
	}
