...
func TestRenderer_Render_WithContent(t *testing.T) {
	...
	buffer.SetString(value2.NewPosition(0, 0), "Hello", style)
...
func TestRenderer_Render_DifferentialUpdate(t *testing.T) {
	...
	// First render
	buffer1 := model2.NewBuffer(80, 24)
	buffer1.SetString(value2.NewPosition(0, 0), "Hello", value2.NewStyle())
	...
	buffer2 := model2.NewBuffer(80, 24)
	buffer2.SetString(value2.NewPosition(0, 0), "World", value2.NewStyle())
...
func TestRenderer_Render_NoChanges(t *testing.T) {
	...
	buffer := model2.NewBuffer(80, 24)
	buffer.SetString(value2.NewPosition(0, 0), "Hello", value2.NewStyle())
...
func BenchmarkRenderer_Render_SmallChange(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		buffer := model2.NewBuffer(80, 24)
		buffer.SetString(value2.NewPosition(0, 0), "Test", value2.NewStyle())
		_ = r.Render(buffer)
	}
}
...
func TestRenderer_Render_DimensionChange_TriggersFullRedraw(t *testing.T) {
	...
	buffer2 := model2.NewBuffer(100, 30)
	buffer2.SetString(value2.NewPosition(0, 0), "World", value2.NewStyle())
	err = r.Render(buffer2)
	require.NoError(t, err)
...
func TestRenderer_RenderFullScreen_WithEmptyCells(t *testing.T) {
	...
	buffer := model2.NewBuffer(80, 24)
	buffer.SetString(value2.NewPosition(0, 0), "Line 1", value2.NewStyle())
	buffer.SetString(value2.NewPosition(0, 2), "Line 3", value2.NewStyle())
	// Line 1 is empty (should be skipped)

	// Trigger full redraw by changing dimensions
	buffer2 := model2.NewBuffer(90, 30)
	buffer2.SetString(value2.NewPosition(0, 0), "Resized", value2.NewStyle())
	err := r.Render(buffer2)
	require.NoError(t, err)
...
func TestRenderer_RenderFullScreen_AllCellsFilled(t *testing.T) {
	...
	// Fill entire buffer
	buffer := model2.NewBuffer(10, 5)
	buffer.Fill('X', value2.NewStyleWithFg(value2.ColorBlue))
...
func TestRenderer_ApplyOperations_AllTypes(t *testing.T) {
	...
	buffer1 := model2.NewBuffer(80, 24)
	buffer1.SetString(value2.NewPosition(0, 0), "Initial", value2.NewStyle())
	err := r.Render(buffer1)
	require.NoError(t, err)
	...
	buffer2.SetString(value2.NewPosition(0, 0), "Changed", value2.NewStyle())
...
func TestRenderer_ApplyOperations_WithStyles(t *testing.T) {
	...
	// First render
	buffer1 := model2.NewBuffer(80, 24)
	buffer1.SetString(value2.NewPosition(0, 0), "Red", value2.NewStyleWithFg(value2.ColorRed))
	err := r.Render(buffer1)
	require.NoError(t, err)
	...
	// Change style
	buffer2 := model2.NewBuffer(80, 24)
	buffer2.SetString(value2.NewPosition(0, 0), "Red", value2.NewStyleWithFg(value2.ColorBlue))
	err = r.Render(buffer2)
	require.NoError(t, err)
...
func TestRenderer_Render_LargeChangeTriggersFullRedraw(t *testing.T) {
	...
	buffer1 := model2.NewBuffer(80, 24)
	buffer1.SetString(value2.NewPosition(0, 0), "Small", value2.NewStyle())
	err := r.Render(buffer1)
	require.NoError(t, err)
	...
	for y := 0; y < 24; y++ {
		for x := 0; x < 70; x++ { // Fill most of the line
			buffer2.Set(value2.NewPosition(x, y), model2.NewCell('X', value2.NewStyle()))
		}
	}
...
func TestRenderer_Resize_WithClear(t *testing.T) {
	...
	// Add content
	buffer := model2.NewBuffer(80, 24)
	buffer.SetString(value2.NewPosition(0, 0), "Content", value2.NewStyle())
	_ = r.Render(buffer)
...
func TestRenderer_ConcurrentAccess(_ *testing.T) {
	...
	for i := 0; i < 5; i++ {
		go func(n int) {
			buffer := model2.NewBuffer(80, 24)
			buffer.SetString(value2.NewPosition(0, 0), fmt.Sprintf("Thread %d", n), value2.NewStyle())
			_ = r.Render(buffer)
			done <- true
		}(i)
	}
...
func TestRenderer_Render_StyleOptimization(t *testing.T) {
	...
	buffer1.SetString(value2.NewPosition(0, 0), "Hello", style)
	err := r.Render(buffer1)
	require.NoError(t, err)
	...
	buffer2 := model2.NewBuffer(80, 24)
	buffer2.SetString(value2.NewPosition(0, 0), "World", style)
	err = r.Render(buffer2)
	require.NoError(t, err)
