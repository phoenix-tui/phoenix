...
import (
	...
	"github.com/phoenix-tui/phoenix/render/application"
...
func NewBuffer(width, height int) *Buffer {
	return &Buffer{
		internal: model.NewBuffer(width, height),
	}
}
...
func (b *Buffer) Set(x, y int, char rune, style Style) {
	...
	cell := model.NewCell(char, style.internal)
...
var (
	ColorBlack   = value.ColorBlack
	ColorRed     = value.ColorRed
	ColorGreen   = value.ColorGreen
	ColorYellow  = value.ColorYellow
	ColorBlue    = value.ColorBlue
	ColorMagenta = value.ColorMagenta
	ColorCyan    = value.ColorCyan
	ColorWhite   = value.ColorWhite
)
