...
func (s *DiffService) Diff(oldBuf, newBuf *model.Buffer) []DiffOp {
...
func (s *DiffService) diffFullBuffer(buf *model.Buffer) []DiffOp {
	var ops []DiffOp
...
func (s *DiffService) DiffLine(oldLine, newLine []model.Cell, y int) []DiffOp {
...
func (s *DiffService) CountChanges(oldBuf, newBuf *model.Buffer) int {
...
func (s *DiffService) HasChanges(oldBuf, newBuf *model.Buffer) bool {
	if oldBuf == nil || newBuf == nil {
		return true
	}
