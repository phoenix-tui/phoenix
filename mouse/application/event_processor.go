...
import (
	...
	"github.com/phoenix-tui/phoenix/mouse/domain/service"
...
type EventProcessor struct {
	clickDetector    *service.ClickDetector
	dragTracker      *service.DragTracker
	scrollCalculator *service.ScrollCalculator
}

// NewEventProcessor creates a new EventProcessor with default settings.
func NewEventProcessor() *EventProcessor {
	return &EventProcessor{
		clickDetector:    service.NewClickDetector(500*1000000, 1), // 500ms, 1 cell tolerance
		dragTracker:      service.NewDragTracker(2),                // 2 cell threshold
		scrollCalculator: service.NewScrollCalculator(3),           // 3 lines per scroll
	}
}
...
func NewEventProcessorWithConfig(
	...
	return &EventProcessor{
		clickDetector:    service.NewClickDetector(clickTimeout, clickTolerance),
		dragTracker:      service.NewDragTracker(dragThreshold),
		scrollCalculator: service.NewScrollCalculator(linesPerScroll),
	}
}
