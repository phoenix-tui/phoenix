...
func TestClickDetector_SingleClick(t *testing.T) {
	...
	if clickEvent.Type() != value.EventClick {
...
func TestClickDetector_DoubleClick(t *testing.T) {
	...
	if clickEvent.Type() != value.EventDoubleClick {
...
func TestClickDetector_RapidClicking(t *testing.T) {
	...
	if click1.Type() != value.EventClick {
	...
	if click2.Type() != value.EventDoubleClick {
	...
	if click3.Type() != value.EventTripleClick {
	...
	if click4.Type() != value.EventClick {
...
func TestClickDetector_PositionTolerance(t *testing.T) {
	detector := NewClickDetector(500*time.Millisecond, 1)
	basePos := value.NewPosition(10, 10)
	...
	tests := []struct {
		name     string
		pos      value.Position
		expected value.EventType
	}{
		{
			name:     "Same position",
			pos:      value.NewPosition(10, 10),
			expected: value.EventDoubleClick,
		},
		{
		...
		{
			name:     "Within tolerance: -1 X",
			pos:      value.NewPosition(9, 10),
			expected: value.EventDoubleClick,
		},
		{
			name:     "Within tolerance: +1 Y",
			pos:      value.NewPosition(10, 11),
			expected: value.EventDoubleClick,
		},
		{
			name:     "Within tolerance: -1 Y",
			pos:      value.NewPosition(10, 9),
			expected: value.EventDoubleClick,
		},
		{
			name:     "Outside tolerance: +2 X",
			pos:      value.NewPosition(12, 10),
			expected: value.EventClick,
		},
		{
			name:     "Outside tolerance: -2 X",
			pos:      value.NewPosition(8, 10),
			expected: value.EventClick,
		},
		{
...
func TestClickDetector_DifferentButtons(t *testing.T) {
	...
	if click.Type() != value.EventClick {
