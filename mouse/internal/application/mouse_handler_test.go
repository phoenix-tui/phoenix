...
func TestParseSequence_SGR_Press(t *testing.T) {
	...
	if event.Button() != value2.ButtonLeft {
...
func TestParseSequence_SGR_Release(t *testing.T) {
	...
	for _, event := range events {
		if event.Type() == value2.EventRelease {
			hasRelease = true
			break
		}
	}
...
func TestParseSequence_SGR_ButtonNone(t *testing.T) {
	...
	event := events[0]
	if event.Button() != value2.ButtonNone {
...
func TestParseSequence_SGR_Scroll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			event := events[0]
			if event.Type() != value2.EventScroll {
...
func TestParseSequence_EnrichmentWithPressRelease(t *testing.T) {
	...
	if len(events1) != 1 || events1[0].Type() != value2.EventPress {
...
func TestIntegration_MultipleButtons(t *testing.T) {
	...
	buttons := []struct {
		...
		{"Left", "0", value2.ButtonLeft},
		{"Middle", "1", value2.ButtonMiddle},
		{"Right", "2", value2.ButtonRight},
	}
