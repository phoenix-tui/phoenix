...
import (
	...
	parser2 "github.com/phoenix-tui/phoenix/mouse/internal/infrastructure/parser"
	"github.com/phoenix-tui/phoenix/mouse/internal/infrastructure/platform"
)
...
type MouseHandler struct {
	...
	sgrParser      *parser2.SGRParser
	x10Parser      *parser2.X10Parser
	urxvtParser    *parser2.URxvtParser
...
func NewMouseHandler() *MouseHandler {
	return &MouseHandler{
		...
		sgrParser:      parser2.NewSGRParser(),
		x10Parser:      parser2.NewX10Parser(),
		urxvtParser:    parser2.NewURxvtParser(),
