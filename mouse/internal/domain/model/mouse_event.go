...
func (e MouseEvent) Type() value2.EventType {
	return e.eventType
}

// Button returns the button.
func (e MouseEvent) Button() value2.Button {
	return e.button
}

// Position returns the position.
func (e MouseEvent) Position() value2.Position {
	return e.position
}

// Modifiers returns the modifiers.
func (e MouseEvent) Modifiers() value2.Modifiers {
	return e.modifiers
}
...
func (e MouseEvent) WithType(eventType value2.EventType) MouseEvent {
	return MouseEvent{
		eventType: eventType,
		button:    e.button,
		position:  e.position,
...
func (e MouseEvent) IsAt(pos value2.Position, tolerance int) bool {
