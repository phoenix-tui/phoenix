...
require (
	github.com/phoenix-tui/phoenix/clipboard v0.1.0-beta.2
	github.com/phoenix-tui/phoenix/core v0.1.0-beta.2
	github.com/phoenix-tui/phoenix/mouse v0.1.0-beta.2
	github.com/phoenix-tui/phoenix/style v0.1.0-beta.2
	github.com/phoenix-tui/phoenix/tea v0.1.0-beta.2
