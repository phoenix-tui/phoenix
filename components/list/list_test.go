...
func TestNew(t *testing.T) {
	...
	// Use explicit type to avoid ambiguity with internal value.SelectionMode
...
func TestNew_PanicOnMismatchedLengths(t *testing.T) {
	...
	New(values, labels, SelectionModeSingle)
}
...
func TestList_ItemRenderer(t *testing.T) {
	...
	customRenderer := func(_ interface{}, index int, _, _ bool) string {
...
func TestList_Filter(t *testing.T) {
	...
	customFilter := func(item interface{}, _ string) bool {
		s := item.(string)
