...
import (
	...
	"github.com/phoenix-tui/phoenix/components/viewport/domain/service"
	"github.com/phoenix-tui/phoenix/components/viewport/domain/value"
...
func NewViewport(width, height int) *Viewport {
	return &Viewport{
		content:      []string{},
		size:         value.NewViewportSize(width, height),
		scrollOffset: value.NewScrollOffset(0),
		followMode:   false,
		wrapLines:    false,
...
func (v *Viewport) ScrollToTop() *Viewport {
	newV := v.clone()
	newV.scrollOffset = value.NewScrollOffset(0)
